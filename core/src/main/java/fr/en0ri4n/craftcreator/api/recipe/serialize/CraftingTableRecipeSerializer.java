...
public final class CraftingTableRecipeSerializer {

    private CraftingTableRecipeSerializer() {}

    /**
     * Build a shaped crafting recipe JSON (minecraft:crafting_shaped).
     */
    public static JsonObject shaped(Identifier resultId,
                                    int resultCount,
                                    CraftingGrid grid) {
     ...
     */
    public static JsonObject shapeless(Identifier resultId,
                                       int resultCount,
                                       RecipeEntry.MultiInput inputs) {
        JsonObject root = new JsonObject();
